 ...
 *
 * Run: node data/seeds/eo-pilot.seed.js
 */
...
const DATA_DIR = join(__dirname, '../local');
...
const organizations = [
  {
    id: 'eo-global-001',
    name: 'Entrepreneurs\' Organization — Global',
    type: 'global',
    parent_id: null,
    region: 'Global',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'es', 'pt', 'ja', 'zh'], display_currency: 'USD' },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    id: 'eo-apac-001',
    name: 'EO Asia Pacific',
    type: 'regional',
    parent_id: 'eo-global-001',
    region: 'Asia Pacific',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'ja', 'zh'], display_currency: 'USD' },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    id: 'eo-noam-001',
    name: 'EO North America',
    type: 'regional',
    parent_id: 'eo-global-001',
    region: 'North America',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'es'], display_currency: 'USD' },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    id: 'eo-europe-001',
    ...
    region: 'Europe',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'es', 'pt'], display_currency: 'EUR' },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    id: 'eo-latam-001',
    name: 'EO Latin America',
    type: 'regional',
    parent_id: 'eo-global-001',
    region: 'Latin America',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'es', 'pt'], display_currency: 'USD' },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    id: 'eo-japan-001',
    name: 'EO Japan',
    type: 'chapter',
    parent_id: 'eo-apac-001',
    region: 'Asia Pacific',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'ja'], display_currency: 'JPY' },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    id: 'eo-singapore-001',
    ...
    region: 'Asia Pacific',
    active: true,
    config: { health_push_enabled: false, languages: ['en', 'zh'], display_currency: 'SGD' },
    created_at: '2026-04-01T00:00:00.000Z'
  }
];
...
const events = [
  {
    ...
    venue: {
      ...
      city: 'Tokyo',
      country: 'Japan',
      rental_cost_usd_cents: 12000000,
      deposit_usd_cents: 2400000,
    ...
    lodging: {
      ...
      rooms_reserved: 80,
      nights: 5,
      cost_per_room_per_night_usd_cents: 45000,
      total_usd_cents: 18000000,
      includes_translator_lodging: true
    },
    airfare: {
      groups: [
    ...
    budget_summary: {
      venue_total_usd_cents:       12500000,
      lodging_total_usd_cents:     18000000,
      airfare_total_usd_cents:      7000000,
      per_diem_total_usd_cents:     1300000,
      translation_total_usd_cents:    940000,
      materials_total_usd_cents:    1480000,
      support_total_usd_cents:      1500000,
      grand_total_usd_cents:       42720000,
      grand_total_display:       6386640,
      last_calculated: '2026-04-01T00:00:00.000Z'
    },
    created_at: '2026-04-01T00:00:00.000Z'
  },
  {
    ...
    venue: {
      ...
      city: 'Singapore',
      country: 'Singapore',
      rental_cost_usd_cents: 4000000,
      deposit_usd_cents: 800000,
      deposit_due_date: '2026-05-01',
      support_costs: []
    },
    lodging: {
      property_name: 'Marina Bay Sands Hotel',
      room_type: 'standard',
      rooms_reserved: 40,
      nights: 3,
      cost_per_room_per_night_usd_cents: 30000,
      total_usd_cents: 3600000,
      includes_translator_lodging: false
    },
    airfare: { groups: [], total_usd_cents: 0 },
    per_diem: {
      staff: { daily_rate_usd_cents: 12000, headcount: 6, days: 3, total_usd_cents: 216000 },
      support_personnel: { daily_rate_usd_cents: 8000, headcount: 4, days: 3, total_usd_cents: 96000 },
      total_usd_cents: 312000
    },
    ...
    budget_summary: {
      venue_total_usd_cents:  4000000,
      lodging_total_usd_cents: 3600000,
      airfare_total_usd_cents:       0,
      per_diem_total_usd_cents: 312000,
      translation_total_usd_cents:   0,
      materials_total_usd_cents:     0,
      support_total_usd_cents:       0,
      grand_total_usd_cents:   7912000,
      grand_total_display:    10602080,
      last_calculated: '2026-04-01T00:00:00.000Z'
    },
    created_at: '2026-04-01T00:00:00.000Z'
  }
...
const friction_log = [
  {
    id: 'fl-001',
    organization_id: 'eo-global-001',
    logged_by: 'user-ed-001',
    log_date: '2026-03-15',
    category: 'Communication',
    description: 'GLC planning timeline was shared with regions 3 weeks later than the standard lead time, causing scheduling conflicts for several chapter presidents.',
    severity: 'Medium',
    resolved: true,
    resolved_at: '2026-03-22T00:00:00.000Z',
    resolution_notes: 'Timeline process updated; communications now go out 90 days ahead.',
    created_at: '2026-03-15T00:00:00.000Z'
  },
  {
    id: 'fl-002',
    organization_id: 'eo-apac-001',
    logged_by: 'user-rd-001',
    log_date: '2026-03-20',
    category: 'Process',
    description: 'Approval workflow for regional event budgets requires three sign-offs but one approver has been unresponsive for 2 weeks, creating a bottleneck.',
    severity: 'High',
    resolved: false,
    resolved_at: null,
    resolution_notes: '',
  ...
  {
    id: 'fl-003',
    organization_id: 'eo-japan-001',
    logged_by: 'user-cs-001',
    log_date: '2026-03-28',
    category: 'Resource',
    description: 'Chapter operating budget for Q2 has not been confirmed by regional office despite two follow-ups. Cannot plan spring programming.',
    severity: 'High',
    resolved: false,
    resolved_at: null,
    resolution_notes: '',
  ...
  },
  {
    id: 'fl-004',
    organization_id: 'eo-global-001',
    logged_by: 'user-hr-001',
    log_date: '2026-04-02',
    category: 'Structural',
    description: 'Role boundaries between Senior Director and Regional Director are unclear in the APAC structure, leading to duplicated effort on the summit planning.',
    severity: 'Medium',
    resolved: false,
    resolved_at: null,
    resolution_notes: '',
  ...
  },
  {
    ...
    log_date: '2026-04-05',
    category: 'Authority',
    description: 'Regional director authorized a vendor contract within their stated authority, but global finance team required additional approval not specified in the policy.',
    severity: 'Low',
    resolved: true,
    resolved_at: '2026-04-07T00:00:00.000Z',
    resolution_notes: 'Policy updated to clarify authorization thresholds.',
...
const org_health_signals = [
  {
    ...
    soil_score: 72,
    seed_score: 65,
    friction_density: 1.4,
    legitimacy_index: null,
    plh_distribution: null,
    readiness_output: 'Grounded',
    org_type: 'global',
    org_size_band: 'large',
    region_code: 'GLOBAL',
    respondent_count: 14,
  ...
  },
  {
    ...
    soil_score: 58,
    seed_score: 57,
    friction_density: 2.1,
    legitimacy_index: null,
    plh_distribution: null,
    readiness_output: 'Rebuilding',
    org_type: 'regional',
...
function write(filename, data) {
  ...
  console.log(`Written: ${path} (${data.length} records)`);
}

write('organizations.json',   organizations);
write('users.json',           users);
write('events.json',          events);
write('friction_log.json',    friction_log);
write('org_health_signals.json', org_health_signals);

console.log('\nEO Pilot seed complete.');
